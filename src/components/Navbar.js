...
const Navbar = () => {
    return (
        <header className=' h-[80px] shadow-sm px-8'>
            <nav className='flex justify-between text-center flex-end p-2 items-cente'>
                ...
                <div className="nav-links-btn flex text-center align-middle ">
                    <ul className='flex justify-between  items-center'  >
                        <li className='px-6'><a className='active:font-bold' href="/">Home</a></li>
                        <li className='px-6  '><a className='hover:text-blue-800 ' href="/about">Events</a></li>
                        <li className='px-6'><a className='hover:text-blue-800 ' href="/">Creators</a></li>
                        <li className='px-6'><a className='hover:text-blue-800 ' href="/">Buyers</a></li>
                        <li className='px-6'><a className='hover:text-blue-800 ' href="/">About</a></li>
                    </ul>
                    <button type="submit" className='border-solid border-2 border-blue-500 px-[17px] py-4 rounded-lg'>Connect Wallet</ button>
                </div>
